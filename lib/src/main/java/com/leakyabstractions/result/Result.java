 ...
 * <p>
 * {@code Result} is a value-based class that describes one of these mutually-exclusive fulfillment states:
 * <ul>
...
public interface Result<S, F> {
    ...
    /**
     * Return the contained value if this is a successful result; otherwise return {@code other}.
     *
     * @param other the value to be returned if this is a failed result, may be {@code null}
     * @return the contained value if this is a successful result; otherwise {@code other}
     * @see Result#isSuccess()
     */
    S orElse(S other);

    /**
     * Return the contained value if this is a successful result; otherwise return a value to be created by the provided
     * mapping function.
     * <p>
     * If this is a failed result, the contained <em>failure</em> value will be applied to the provided mapping
     * {@link Function} to produce an alternative <em>success</em> value.
     *
     * @param failureMapper a mapping function which will produce the value to be returned if this is a failed result
     * @return the contained value if this is a successful result; otherwise a value to be created by the provided
     *         mapping function
    ...
    /**
     * Return the contained value if this is a successful result; otherwise throws {@code NoSuchElementException}.
     *
     * @return the contained value if this is a successful result, may be {@code null}
    ...
    /**
     * Return the contained value if this is a successful result; otherwise throw an exception to be created by the
     * provided mapping function.
     * <p>
     * If this is a failed result, the contained <em>failure</em> value will be applied to the provided mapping
     * {@link Function} to produce an exception.
     * 
     ...
     * @return the contained value if this is a successful result
    ...
    /**
     * Return the contained value if this is a failed result; otherwise throws {@code NoSuchElementException}.
     *
     * @return the contained value if this is a failed result, may be {@code null}
    ...
    /**
     * Invoke the provided consumer with the contained value if this is a successful result; otherwise do nothing.
     * 
     * @param successHandler block to be executed if this is a successful result
    ...
    /**
     * Invoke the provided consumer with the contained value if this is a failed result; otherwise do nothing.
     * 
     * @param failureHandler block to be executed if this is a failed result
     ...
     * 
     * @param predicate a predicate to apply to the contained value if this is a successful result
    ...
    /**
     * Apply the appropriate mapping {@link Function} to the contained value and return a new {@code Result} with the
     * produced value.
     * <p>
     * Depending on the fulfillment state, the contained value will be applied to either one of the provided mapping
     * functions to produce a new value. Then the new {@code Result} will be created with the same fulfillment state and
     * the produced value. The types of the new success/failure values may be different from this result's.
     * 
     * @param <S2> the type of the new success value
     * @param <F2> the type of the new failure value
     * @param successMapper a mapping {@code Function} to apply to the contained value if this is a successful result
     * @param failureMapper a mapping {@code Function} to apply to the contained value if this is a failed result
     ...
     * @return a new {@code Result} whose contained value depends on this result's contained value
     */
    <S2, F2> Result<S2, F2> map(Function<? super S, S2> successMapper, Function<? super F, F2> failureMapper);

    /**
     * Apply the provided mapping {@link Function} to the contained value if this is a successful result and return a
     * new successful {@code Result} with the produced value; otherwise return a failed result with the same
     * <em>failure</em> value.
     * <p>
     * If this is a successful result, the contained value will be applied to the provided mapping {@code Function} to
    ...
    /**
     * Apply the provided mapping {@link Function} to the contained value if this is a failed result and return a new
     * failed {@code Result} with the produced value; otherwise return a successful result with the same
     * <em>success</em> value.
     * <p>
     * If this is a failed result, the contained value will be applied to the provided mapping {@code Function} to
     * produce a new value. Then the new failed {@code Result} will be created with the produced value. The type of the
     * new failure value may be different from this result's.
     * 
     * @param <F2> the type of the new failure value
     * @param failureMapper a mapping {@code Function} to apply to the contained value if this is a failed result
     * @throws NullPointerException if this is a failed result and {@code failureMapper} is {@code null}
    ...
    /**
     * Apply the appropriate {@code Result}-bearing mapping {@link Function} to the contained value and return the
     * produced result.
     * <p>
     * Depending on the fulfillment state, the contained value will be applied to either one of the provided mapping
     * functions to produce a new {@code Result}. The fulfillment state and the types of the new success/failure values
     * may be different from this result's.
     * 
     * @param <S2> the type of the new success value
     * @param <F2> the type of the new failure value
     * @param successFlatMapper a {@code Function} to apply to the contained value if this is a successful result; it
     *            must produce a new {@code Result}
     * @param failureFlatMapper a {@code Function} to apply to the contained value if this is a failed result; it must
     ...
     * @return the result of applying a {@code Result}-bearing mapping function to the contained value
     */
    ...
    /**
     * Apply the provided {@code Result}-bearing mapping {@link Function} to the contained value and return the produced
     ...
     * @return the result of applying a {@code Result}-bearing mapping function to the contained value if this is a
     ...
     * <p>
     * If this is a failed result, the contained value will be applied to the provided mapping {@code Function} to
     * produce a new {@code Result}. The fulfillment state and the type of the new failure value may be different from
     * this result's.
     * 
     * @param <F2> the type of the new failure value
     * @param failureFlatMapper a {@code Function} to apply to the contained value if this is a failed result; it must
     ...
     * @return the result of applying a {@code Result}-bearing mapping function to the contained value if this is a
     *         failed result; otherwise a successful result with the same <em>failure</em> value.
     */
