...
import static com.leakyabstractions.result.DefaultResult.*;
...
/**
 * Tests for {@link DefaultResult#combine(Result...)}.
 * 
 * @author Guillermo Calvo
 */
@DisplayName("DefaultResult combineVarArgs")
class DefaultResult_combineVarArgs_Test {
