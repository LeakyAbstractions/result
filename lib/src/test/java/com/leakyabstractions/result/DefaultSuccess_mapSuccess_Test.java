...
/**
 * Tests for {@link DefaultSuccess#map(Function)}.
 * 
...
class DefaultSuccess_mapSuccess_Test {
    ...
    void should_use_success_mapping() {
        ...
        // When
        final Result<Integer, String> result = success.map(successMapper);
        // Then
    ...
    void should_use_success_mapping_even_if_value_is_null() {
        ...
        // When
        final Result<String, Integer> result = success.map(successMapper);
        // Then
